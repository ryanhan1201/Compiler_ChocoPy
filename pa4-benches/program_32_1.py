...
def check_divisibility(n_str:str) -> bool:
    n_int:int = 0
    n_int = str_to_int(n_str)
    if(n_int % secret == 0):
        return True
    return False
...
while (check_divisibility(guess) == False):
    print("Not divisible, guess again.")
    guess = input()

print("Divisible by the secret!")