# Function taken from Alexander Goldberg on Ed
...
def is_even(num: int) -> bool:
    def is_even_pos_only(num: int) -> bool:
        if num == 0:
            return True
        return not is_even_pos_only(num - 1)
    if num < 0:
        return is_even_pos_only(-num)
    return is_even_pos_only(num)

s: str = ""
s = input()
print(s)
print(is_even(str_to_int(s)))
